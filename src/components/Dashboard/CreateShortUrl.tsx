  ...
  return (
    <div className="relative w-full max-w-2xl">
      ...
      <input
        ...
        disabled={disabled}
        className="w-full pl-12 pr-4 py-4 bg-white/10 backdrop-blur-sm border-2 border-white/20 rounded-2xl text-white placeholder:text-white/50 outline-none transition-all duration-200 focus:border-white/50 focus:bg-white/20 disabled:opacity-50 disabled:cursor-not-allowed text-lg"
        value={value}
...
const BackButton = () => {
  ...
  return (
    <button
      onClick={() => router.back()}
      className="group flex items-center gap-2 text-white/70 hover:text-white transition-all duration-200 font-medium"
    >
...
export default function CreateShortUrlPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-zinc-900 via-zinc-800 to-zinc-900 p-6 md:p-10 flex items-center justify-center">
          ...
          <div className="flex flex-col items-center gap-8">
            ...
            <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-4 mt-6 pt-6 border-t border-white/10">
              {[
                ...
                <div key={feature.label} className="text-center text-white/70">
